...
from rdfscene import Scene
from rdfnode import Node
from rdfedge import Edge, EDGE_TYPE_BEZIER
from rdfgraphicsview import QDMGraphicsView


class RdfDiagramWidget(QWidget):
    def __init__(self, parent=None):
        super(RdfDiagramWidget, self).__init__(parent)
    ...
    def loadStylesheet(self, filename):
        ...
        stylesheet = "QDMNodeContentWidget { background: transparent; }\
