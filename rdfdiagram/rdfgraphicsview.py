...
from rdfgraphicssocket import QDMGraphicsSocket
from rdfgraphicsedge import QDMGraphicsEdge
from rdfedge import Edge, EDGE_TYPE_BEZIER
from rdfgraphicscutline import QDMCutLine
...
class QDMGraphicsView(QGraphicsView):
    ...
    def middleMouseButtonPress(self, event):
        ...
        super(QDMGraphicsView, self).mouseReleaseEvent(releaseEvent)
