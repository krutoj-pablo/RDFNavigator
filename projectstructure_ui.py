...
class Ui_ProjectStructureWidget(object):
    def setupUi(self, ProjectStructureWidget):
        ...
        self.objectsStructureWidget = QtWidgets.QTreeWidget(self.objectsTab)
        self.objectsStructureWidget.setAnimated(True)
        self.objectsStructureWidget.setObjectName("objectsStructureWidget")
        self.objectsStructureWidget.headerItem().setText(0, "1")
        self.objectsStructureWidget.header().setVisible(False)
        self.verticalLayout_3.addWidget(self.objectsStructureWidget)
        ...
        self.fsStructureWidget = QtWidgets.QTreeWidget(self.fsTab)
        self.fsStructureWidget.setAnimated(True)
        self.fsStructureWidget.setObjectName("fsStructureWidget")
        self.fsStructureWidget.headerItem().setText(0, "1")
        self.fsStructureWidget.header().setVisible(False)
        self.verticalLayout_4.addWidget(self.fsStructureWidget)
